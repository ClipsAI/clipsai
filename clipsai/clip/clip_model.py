...
class Clip:
    ...
    def __eq__(self, __other: object) -> bool:
        ...
        if not isinstance(__other, Clip):
            return False
        return self._start_time == __other.start_time and \
               self._end_time == __other.end_time and \
               self._start_char == __other.start_char and \
               self._end_char == __other.end_char
    ...
    def __bool__(self) -> bool:
        ...
        """
        return bool(self._start_time) and \
                bool(self._end_time) and \
                bool(self._start_char) and \
                bool(self._end_char)
