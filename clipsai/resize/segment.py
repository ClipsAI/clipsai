...
class Segment:
    ...
    def __eq__(self, __value: object) -> bool:
        ...
        if not isinstance(__value, Segment):
            return False
        return self._speakers == __value.speakers and \
               self._start_time == __value.start_time and \
               self._end_time == __value.end_time and \
               self._x == __value.x and \
               self._y == __value.y
    ...
    def __bool__(self) -> bool:
        ...
        """
        return bool(self._speakers) and \
               bool(self._start_time) and \
