...
from clipsai.resize.facenet_mp import FaceNetMediaPipeResizer
...
@pytest.mark.parametrize("original_width, original_height, aspect_ratio, expected", [
    # Wider aspect ratio
...
# Test cases
@pytest.mark.parametrize("speaker_segments, scene_changes, expected", [
    ...
    (
        [{"speakers": [0], "startTime": 0, "endTime": 5}],
        [5],
        [{"speakers": [0], "startTime": 0, "endTime": 5}]
    ),
    ...
    (
        ...
        [
            {"speakers": [0], "startTime": 0, "endTime": 5}, 
            {"speakers": [0], "startTime": 5, "endTime": 10}
        ]
    ),
    ...
    (
        [
            {"speakers": [0], "startTime": 0, "endTime": 5}, 
            {"speakers": [1], "startTime": 5, "endTime": 10}
        ],
        [3, 8],
        [
            {"speakers": [0], "startTime": 0, "endTime": 3},
            {"speakers": [0], "startTime": 3, "endTime": 5},
            {"speakers": [1], "startTime": 5, "endTime": 8},
            {"speakers": [1], "startTime": 8, "endTime": 10}
        ]
    ),
    ...
    (
        ...
        [4.8],
        [
            {"speakers": [0], "startTime": 0, "endTime": 4.8}, 
            {"speakers": [1], "startTime": 4.8, "endTime": 10}
        ]
    ),
    ...
    (
        ...
        [5.1],
        [
            {"speakers": [0], "startTime": 0, "endTime": 5.1}, 
            {"speakers": [1], "startTime": 5.1, "endTime": 10}
        ]
    ),
])
...
@pytest.mark.parametrize("width, height, num_frames, gpu_available, face_detect_width, n_face_detect_batches, expected_batches", [
...
def test_calc_n_batches(
    ...
    with patch('torch.cuda.is_available', return_value=gpu_available), \
         patch('clipsai.utils.pytorch.get_free_cpu_memory', return_value=8000000000):
...
@pytest.mark.parametrize("roi, resize_width, resize_height, expected_crop", [
    # Test case 1
...
@pytest.mark.parametrize("segments, expected", [
    ...
    (
        [
            {"x": 100, "y": 0, "startTime": 0, "endTime": 10}, 
            {"x": 200, "y": 0, "startTime": 10, "endTime": 20}
        ],
        [
            {"x": 100, "y": 0, "startTime": 0, "endTime": 10}, 
            {"x": 200, "y": 0, "startTime": 10, "endTime": 20}
    ...
    (
        [
            {"x": 100, "y": 0, "startTime": 0, "endTime": 10}, 
            {"x": 100, "y": 0, "startTime": 10, "endTime": 20}
        ],
        [
            {"x": 100, "y": 0, "startTime": 0, "endTime": 20}
        ]
    ),
    ...
    (
        [
            {"x": 100, "y": 0, "startTime": 0, "endTime": 10}, 
            {"x": 100, "y": 0, "startTime": 10, "endTime": 20},
            {"x": 100, "y": 0, "startTime": 20, "endTime": 30}
        ],
        [
            {"x": 100, "y": 0, "startTime": 0, "endTime": 30}
        ]
    ),
    ...
    (
        [
            {"x": 100, "y": 0, "startTime": 0, "endTime": 10}, 
            {"x": 100, "y": 50, "startTime": 10, "endTime": 20}
        ],
        [
            {"x": 100, "y": 0, "startTime": 0, "endTime": 10}, 
            {"x": 100, "y": 50, "startTime": 10, "endTime": 20}
    ...
    (
        [
            {"x": 100, "y": 0, "startTime": 0, "endTime": 10}, 
            {"x": 101, "y": 0, "startTime": 10, "endTime": 20}
        ],
        [
            {"x": 100, "y": 0, "startTime": 0, "endTime": 20}, 
        ]
